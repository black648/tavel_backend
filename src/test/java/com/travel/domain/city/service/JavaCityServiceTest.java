...
//import com.travel.domain.city.dto.JavaCityUpdateDto;
...
//    public void save() {
//        //given
//        cityService.save(JavaCitySaveDto.builder()
//                .name("제천")
...
//    public void update() {
//        //given
//        Long saveCity = cityService.save(JavaCitySaveDto.builder()
//                .name("서울")
//                .category(CityCategory.SEOUL)
//                .build());
//
//        //when
//        cityService.update(saveCity, JavaCityUpdateDto.builder()
//                .name("성남")
